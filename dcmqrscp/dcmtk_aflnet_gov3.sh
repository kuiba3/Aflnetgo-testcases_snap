...
$AFLNET_GO/scripts/gen_distance_fast.py $WORKDIR/dcmtk_3_$1/build/bin/ $TMP_DIR dcmqrscp
...
cd $WORKDIR/dcmtk_3_$1/build/bin
mkdir ACME_STORE 
...
timeout 24h afl-fuzz -A libsnapfuzz.so -z exp -b 15h -d -i $AFLNET_GO/tutorials/dcmqrscp/in-dicom -o out-dicom_test -N tcp://127.0.0.1/$2 -P DICOM -D 10000 -E -K -Z -R -m 1000 ./dcmqrscp 2>logtest.txt
