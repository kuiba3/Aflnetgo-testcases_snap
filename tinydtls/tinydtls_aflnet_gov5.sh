...
export WORKDIR=$PWD/
export AFLNET_GO=$PWD/../aflnet_go_v5
...
$AFLNET_GO/scripts/gen_distance_fast.py $WORKDIR/tinydtls_5_$1/tests/ $TMP_DIR dtls-server
export CFLAGS="$COPY_CFLAGS -distance=$TMP_DIR/distance.cfg.txt"
export CXXFLAGS="$COPY_CXXFLAGS -distance=$TMP_DIR/distance.cfg.txt"

make clean all

cd $WORKDIR/tinydtls_5_$1/tests
