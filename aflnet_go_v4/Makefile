...
PROGS       = afl-gcc afl-fuzz afl-replay aflnet-replay aflnetgo-replay afl-showmap afl-tmin afl-gotcpu afl-analyze
...
aflnetgo-replay: aflnetgo-replay.c $(COMM_HDR) aflnet.o aflnet.h | test_x86
	$(CC) $(CFLAGS) $@.c aflnet.o -o $@ $(LDFLAGS)
